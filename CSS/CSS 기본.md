...
CSS(Cascading Style Sheets)란  글꼴, 글자 크기, 애니메이션, 색상 등 웹 페이지의 스타일이나 레이아웃에 사용되는 **스타일 시트 언어**를 말한다.

HTML이나 XML(XML의 방언인 SVG, XHTML 포함)로 작성된 문서의 스타일을 설정하는데 사용된다.
