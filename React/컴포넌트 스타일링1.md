...
- [Styled-components](#styled-components)
  - [styled-componenet vscode 플러그인](#styled-componenet-vscode-)
- [Styled Components 전역 스타일 적용하기](#styled-components---)
  - [`createGlobalStyle` 함수로 전역 스타일 적용하기](#createglobalstyle----)
  - [Styled-components props 사용하기](#styled-components-props-)
  - [Styled-components 미디어 쿼리 사용하기](#styled-components---)
  - [Styled-components CSS 헬퍼 함수](#styled-components-css--)
  - [`as` prop 사용하기](#as-prop-)
  - [`defaultProps`로 컴포넌트 기본 `props` 설정하기](#defaultprops---props-)
- [`<NavLink>` 컴포넌트 스타일링하기(표준 DOM 이외 요소 스타일링)](#navlink---dom---)
